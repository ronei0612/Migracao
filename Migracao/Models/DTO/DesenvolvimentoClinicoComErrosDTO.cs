...
{
    public class DesenvolvimentoClinicoComErrosDTO
    {
        public DesenvolvimentoClinicoComErrosDTO()
        {

        }

        public DesenvolvimentoClinicoComErrosDTO(List<DesenvolvimentoClinico> desenvolvimentoClinico)
        {
