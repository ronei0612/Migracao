...
namespace Migracao.Models.FirebirdModels
{
    public class EMD101
    {
        ...
        public string DT_ULTMOV { get; set; }
        public string DT_NASCIMENTO { get; set; }
        public string VR_LIMITE { get; set; }
        ...
        public string FUNCAO_ADMISSAO { get; set; }
        public string RENDA_MES { get; set; }
        ...
        public string RENDA_FIA { get; set; }
        public string MODIFICADO { get; set; }
        public string USUARIO_LOJA { get; set; }
        ...
        public string DT_NASC_FIA { get; set; }
        ...
        public string DATA_DEP_EXCLUIDO { get; set; }
        public string TITULAR_DEP_EXCLUIDO { get; set; }
        public string DT_NASCIMENTO_DEP { get; set; }
        ...
        public string LGPD_DATA_HORA { get; set; }
        public string LGPD_CPF { get; set; }
        public string LGPD_TELEFONE { get; set; }
        public string LGPD_MENSAGEM { get; set; }
        public string LGPD_IMAGEM { get; set; }
        public string INSTITUTO_ODC { get; set; }
        public string PROTETICO { get; set; }
        public string PROTETICO_ATIVO { get; set; }
        public string DT_AXON { get; set; }
        public string AXON_ID { get; set; }
        public string ID_DRCASH { get; set; }
        public string DATA_APROVACAO_DRCASH { get; set; }
        public string VALOR_MAXIMO_DRCASH { get; set; }
    }
}
